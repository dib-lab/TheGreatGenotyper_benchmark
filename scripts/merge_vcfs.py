...
def genotype_from_string(gt_string):
	is_phased = False
	alleles = []
	gt_string=gt_string.split(":")[0]
	gt_string= "0|0" if gt_string == "0/0" else gt_string
	gt_string= "0|1" if gt_string == "./1" else gt_string
	gt_string= "1|0" if gt_string == "1/."  else gt_string
	if '|' in gt_string:
		is_phased = True
		alleles = []
...
#		assert len(gt_string) == 1
	...
	if gt_string == "0/0": is_phased=True 

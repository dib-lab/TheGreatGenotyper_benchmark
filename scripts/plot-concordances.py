...
#	methods = ["TheGreatGenotyper", "TheGreatGenotyper" , "NewTheGreatGenotyper",'pangenie', 'pangenie'] if regions not in ['repeats', 'nonrep', 'external'] else ["TheGreatGenotyper", "TheGreatGenotyper", "NewTheGreatGenotyper" ,'pangenie', 'pangenie', 'platypus', 'paragraph', 'gatk', 'graphtyper']
#	legend_methods = ["TheGreatGenotyper(all)", "TheGreatGenotyper(high-gq)", "NewTheGreatGenotyper",'PanGenie (all)', 'PanGenie (high-gq)'] if regions not in ['repeats', 'nonrep', 'external'] else ["TheGreatGenotyper", "TheGreatGenotyper(high-gq)",  "NewTheGreatGenotyper",'PanGenie (all)', 'PanGenie (high-gq)', 'Platypus', 'Paragraph', 'GATK', 'GraphTyper']

#	qualities = ['0', '200','0','0','200'] if regions not in ['repeats', 'nonrep', 'external'] else ['0', '200','0', '0', '200', '0', '0', '0','0']
...
#				continue
			...
			for run in run_mode:
				...
				for j,coverage in enumerate(coverages):
					filename= folder  + "/evaluation/concordance/" + mode + "/" + method + "-" + run + '/coverage-' + str(coverage) + "_" + region + "_" + var + "/qual_" + quality + "/summary.txt"

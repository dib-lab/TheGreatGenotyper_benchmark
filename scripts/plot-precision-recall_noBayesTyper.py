...
def plot_prec_rec(mode, run_mode, variants, folder, outfile, coverages, sample, regions, variantset):
	methods = ['pangenie', 'pangenie'] if regions not in ['repeats', 'nonrep', 'external'] else ['pangenie', 'pangenie', 'platypus', 'paragraph', 'gatk', 'graphtyper']
	legend_methods = ['PanGenie (all)', 'PanGenie (high-gq)'] if regions not in ['repeats', 'nonrep', 'external'] else ['PanGenie (all)', 'PanGenie (high-gq)', 'Platypus', 'Paragraph', 'GATK', 'GraphTyper']

...
def plot_data(bar_df, scatter_df, outputImage):
    ...
    methods_order = ["TheGreatGenotyper-HMM", "TheGreatGenotyper-kmersOnly", "TheGreatGenotyper-SecondPassHMM", "pangenie", "gatk", "paragraph", "graphtyper"]
  ...
  #  plt.title(title)
    ...
    legend2 = plt.legend(handles=legend_elements_region, title="Region Type", loc="upper left", bbox_to_anchor=(0.6, -0.13))
